...
import org.firstinspires.ftc.teamcode.rr.trajectorysequence.util.Encoder;
...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 11.2; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 0.0; // in; offset of the lateral wheel
    public static double X_MULTIPLIER = 1.017; // Multiplier in the X direction
    public static double Y_MULTIPLIER = .986; // Multiplier in the Y direction
