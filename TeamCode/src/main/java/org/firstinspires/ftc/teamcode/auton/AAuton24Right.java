...
public class AAuton24Right extends LinearOpMode {
    public static double FORWARD_1 = 6;
    public static double STRAFE_LEFT = 10;
    public static double ARM1_POWER = 1.0;
    public static double ARM2_POWER = 1.0;
    public static int ARM_1_MOVE_BACK_1_ANGLE = 45;
    public static int ARM_2_MOVE_BACK_1_ANGLE = 90;
    public static int ARM_2_Position_ANGLE = 10;
    ...
    public void runOpMode() {
        ...
        Trajectory trajectoryPosition = drive.trajectoryBuilder(trajectory2.end())
                .forward(5)
                .build();

        Trajectory trajectoryReverse = drive.trajectoryBuilder(trajectory2.end())
                .back(20)
                .build();

        Trajectory trajectoryRest = drive.trajectoryBuilder(trajectory2.end())
                .strafeRight(20)
                .build();
        ...
        drive.followTrajectory(trajectoryPosition);
        moveArmToPosition(DcMotorSimple.Direction.REVERSE, (int)(ARM_2_Position_ANGLE * ARM2_ANGLE_TO_ENCODER), armMotor2);

        drive.followTrajectory(trajectoryReverse);
        drive.followTrajectory(trajectoryRest);
