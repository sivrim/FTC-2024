...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 12.37; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 1; // in; offset of the lateral wheel
    public static double X_MULTIPLIER = .992; // Multiplier in the X direction
    public static double Y_MULTIPLIER = .99; // Multiplier in the Y direction
