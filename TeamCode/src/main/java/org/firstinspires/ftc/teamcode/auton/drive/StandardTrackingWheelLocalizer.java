...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 11.35; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 0.5; // in; offset of the lateral wheel
    public static double X_MULTIPLIER = 1; // Multiplier in the X direction
    public static double Y_MULTIPLIER = .96; // Multiplier in the Y direction
